module github.com/hood-chat/core

go 1.19

// temperary patch fpr fixing arm64 turnicating error
replace github.com/timshannon/badgerhold/v4 v4.0.2 => github.com/hood-chat/badgerhold/v4 v4.0.3
